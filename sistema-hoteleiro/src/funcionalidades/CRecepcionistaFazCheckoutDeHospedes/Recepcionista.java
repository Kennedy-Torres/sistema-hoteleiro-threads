...
public class Recepcionista extends Thread {
    ...
    private void alocarGrupo(Quarto quarto, GrupoHospedes grupo) {
        if (quarto.isDisponivel()) {
            ...
            quarto.adicionarGrupoDeHospedeEmUmaLista(grupo); // o grupo é adicionado a uma lista de GrupoHospede, essa lista contem todos os grupos; em seguida associamos este grupo a um quarto
...
//    }
    private void checkOut(GrupoHospedes grupo, Quarto quarto) {
//        System.out.println("numero de hospedes(quarto"+quarto.getNumeroQuarto()+"):"+quarto.getHospedes().size());
//        System.out.println("nomes:"+quarto.getHospedes().get(0).getNome());
//        System.out.println("nomes:"+quarto.getHospedes().get(1).getNome());
//        System.out.println("nomes:"+quarto.getHospedes().get(2).getNome());
//        System.out.println("nomes:"+quarto.getHospedes().contains(grupo));
