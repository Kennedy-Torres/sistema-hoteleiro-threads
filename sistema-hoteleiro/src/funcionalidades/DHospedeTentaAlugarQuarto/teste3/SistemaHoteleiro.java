...
public class SistemaHoteleiro {
    public static void main(String[] args) {
        ...
        // Lista para armazenar as camareiras
//        List<Camareira> camareiras = new ArrayList<>();
//        for (int i = 0; i < quartos.size(); i++) {
//            Camareira camareira = new Camareira("Camareira " + (i + 1), quartos.get(i));
...
//        Hospede hospede1 = new Hospede("John");
//        grupo1.adicionarHospedeDentroDoGrupo(hospede1);
        ...
        Camareira c1 = new Camareira("Camareira 1", quartos.get(0));
        c1.start();
